...
public class MyFTPClientFunctions {
     ...
     * be upload to
     */
    /*public boolean ftpUploadMultiple(ArrayList<FileUploadModel> myModels, String desDirectory, Context context) {
        ...
        try {
            ...
            if (ftpChangeDirectory(desDirectory)) {
                ...
                for (int i = 0; i < myModels.size(); i++) {
                    ...
                    FileUploadModel myModel = new FileUploadModel();
                    myModel.setPath(myModels.get(i).getPath());
                    myModel.setName(myModels.get(i).getName());

                    in = new FileInputStream(myModel.getPath());
                    status = mFTPClient.storeFile(myModel.getName(), in);
